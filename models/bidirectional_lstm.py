...
class BidirectionalLSTM(nn.Module):
    def __init__(self, config, pad_idx):
        ...
        # pass padding_idx to model not to train padding token
    ...
    def forward(self, input, input_lengths):
        ...
        # assert torch.equal(output[-1, :, :], hidden[-2, :, :])
        # above code makes AssertionError because output has pad tokens as last elements but hidden doesn't
